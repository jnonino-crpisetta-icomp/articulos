...
%	Archivo: 2_redes_petri_tiempo.tex												%
%																					%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%	REVISIONES																		%
%																					%
...
%	COMIENZO DEL DOCUMENTO
	\begin{document}
		...
		% TITULO y AUTORES
		\input{./title_authors/espanol}

		% RESUMEN
		\input{./abstract/espanol}

		% INTRODUCCION
		\input{./introduction/espanol}
		
		% REDES DE PETRI
		%\input{./basic_petri_nets/espanol}
		\input{./petri_nets/espanol}
	
		% REDES DE PETRI CON TIEMPO
		\input{./time_petri_nets/espanol}

		% IP CORE
		\input{./ip_core/espanol}

		% ARQUITECTURA
		%\input{./architecture/espanol}

		% ANALISIS DE RENDIMIENTO
		\input{./performance/espanol}
			
		% CONCLUSION
		\input{./conclusion/espanol}

		% Conference papers DO NOT normally have an appendix
		%\input{./appendix/espanol}

		% AGRADECIMIENTOS
		\input{./acknowledgment/espanol}
	...
	%	REFERENCIAS
		...
		%\bibitem{PaperProcesador}{Micolini, Orlando; Pereyra, Martin M.; Gallia, Nicolas A.; Alasia, Melisa A. Sistema Multi-Core 
		%Heterogeneo, sincronizado por un Procesador de Petri sobre FPGA.}

		% BIOGRAFIAS
		\input{./biography/espanol}
