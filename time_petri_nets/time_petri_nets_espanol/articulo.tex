...
%	COMIENZO DEL DOCUMENTO
	...
	%	\input{redes_de_petri}
	
	%	REDES DE PETRI TEMPORALES
		\input{redes_de_petri_temporales}
		
	%	REDES DE PETRI CON TIEMPO
		\input{redes_de_petri_con_tiempo}

	%	IP core
		\input{ip_core}

	%	Analisis de Rendimiento
		\input{analisis_rendimiento}
		
	%	CRECIMIENTO DEL IP CORE
		\input{crecimiento_ip_core}		
