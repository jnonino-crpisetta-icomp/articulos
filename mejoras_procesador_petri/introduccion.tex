...
\section{Introducción}
	...
	\IEEEPARstart{E}{}l presente trabajo inició con el estudio realizado sobre el 
	Procesador de Petri (PP) descripto en trabajos previos \cite{PaperProcesador}.
	
	Luego de evaluar sus capacidades y funcionamiento se diseñaron distintas alternativas 
...
%\hfill January 11, 2007
	...
	\subsection{Objetivos}
		...
		\begin{itemize}
	  		...
	  		\item Determinar cantidad máxima de tokens por plaza (Plazas Acotadas).
	  		\item Capacidad para contemplar transiciones automáticas.
	  		\item Cambio de colas de entrada y salida de disparos. 
	  		\item Generar soporte para interrupciones enmascarables.
	  		\item Analisis de crecimiento del tamaño del procesador.
		\end{itemize}
