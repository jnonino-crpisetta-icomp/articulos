...
%	DOCUMENT BEGINING
	\begin{document}		
		...
		% TITLE AND AUTHORS
		\input{./title_authors/english}
		
		% ABSTRACT
		\input{./abstract/english}

		% INTRODUCTION
		\input{./introduction/english}

		% PETRI NETS
		%\input{./basic_petri_nets/english}
		\input{./petri_nets/english}
		\input{./timed_petri_nets/english}
		
		% ARCHITECTURE AND OPERATION
		\input{./architecture/english}
		%\input{./ip_core/english}

		% PERFORMANCE
		%\input{./performance/english}

		% CONCLUSION
		\input{./conclusion/english}

		% Conference papers DO NOT normally have an appendix
		% \input{./appendix/english}

		% ACKNOWLEDGEMENT
		\input{./acknowledgment/english}
