...
estén sensibilizadas, la resolución de un disparo  representaran el cumplimiento de dichas restricciones y si 
asociamos la solicitud de verificación de las condiciones a la solicitud de un disparo, la resolución de un 
