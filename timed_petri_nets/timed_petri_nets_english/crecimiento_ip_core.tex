...
\section{Crecimiento del IP Core}
		Una vez visto el correcto funcionamiento del IP Core, se evaluó el crecimiento del procesador 
		en función de los parámetros que posee. Para esto se generaron procesadores de 8x8, 16x16, 
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=3in]{./img/resultados09}
		...
		se incrementa rápidamente a medida que aumentamos el tamaño de elementos soportados.
